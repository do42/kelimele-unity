...
public class WordTimeApi : MonoBehaviour
{
	#region Singleton class: WordTimeApi

	public static WordTimeApi Instance;
    ...
    private void Update()
    {
		if (WordTimeApi.Instance.IsTimeLodaed)
		{
			DateTime currentDateTime = WordTimeApi.Instance.GetCurrentDateTime();
